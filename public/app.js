(() => {
  ...
  function setupTumorMap() {
    ...
    const data = {
      PSA: {
        title: 'สัมพันธ์กับ prostate',
        use: 'ใช้ประกอบการตัดสินใจเรื่อง prostate cancer ในบริบทที่เหมาะสม และใช้ติดตามในผู้ที่วินิจฉัยแล้ว',
        caution: 'อาจสูงจาก benign prostatic hyperplasia, prostatitis และปัจจัยรอบการตรวจได้',
        organs: ['prostate']
      },
      AFP: {
        title: 'สัมพันธ์กับ liver และ germ-cell tumors',
        use: 'ใช้ช่วยประเมินและติดตาม hepatocellular carcinoma หรือ germ-cell tumor เมื่อบริบทสนับสนุน',
        caution: 'อาจสูงจากโรคตับเรื้อรัง ตับอักเสบ การตั้งครรภ์ และภาวะที่ไม่ใช่มะเร็ง',
        organs: ['liver', 'germ']
      },
      CEA: {
        title: 'สัมพันธ์กับ colorectal และ adenocarcinoma บางชนิด',
        use: 'เหมาะกับการติดตามแนวโน้มหลังวินิจฉัย โดยเฉพาะ colorectal cancer มากกว่าการคัดกรองคนทั่วไป',
        caution: 'การสูบบุหรี่ การอักเสบ และโรคตับอาจทำให้ค่าสูงได้',
        organs: ['colon']
      },
      CA125: {
        title: 'สัมพันธ์กับ ovary และ peritoneum',
        use: 'ใช้ประกอบการประเมินก้อน adnexal และติดตาม ovarian/peritoneal cancer ในบริบทที่เหมาะสม',
      ...
      CA199: {
        ...
        caution: 'cholestasis หรือ biliary obstruction ทำให้สูงมากได้ และผู้ที่เป็น Lewis-negative อาจไม่สร้าง CA 19-9',
        organs: ['pancreas']
      },
      BHCG: {
        title: 'สัมพันธ์กับ germ-cell และ trophoblastic disease',
        use: 'ช่วยวินิจฉัย จัดกลุ่มความเสี่ยง และติดตาม germ-cell/trophoblastic tumors ตามบริบท',
        caution: 'การตั้งครรภ์เป็นสาเหตุทางสรีรวิทยาที่สำคัญ จึงต้องแปลผลตามเพศ อายุ และบริบท',
        organs: ['germ']
      }
    };
